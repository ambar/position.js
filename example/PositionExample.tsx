...
import position, {presets} from '../src'
...
class PositionExample extends React.Component {
  ...
  reposition = () => {
    ...
    if (expectedPlacement) {
      ...
      } = position(this.popup, this.anchor, expectedPlacement, {
        fixed,
        adjustXY,
  ...
  handleOptionsChange(state) {
    if (
      state.offsetParent === 'scroller' &&
      state.offsetParent !== this.state.offsetParent
    ) {
        ...
        <section className={styles.options}>
          ...
          <div>
            ...
            <Select
              ...
              value={String(fixed)}
              onChange={(value) =>
                this.handleOptionsChange({fixed: value === 'true'})
              }
            />
          </div>
          ...
          <div>
            ...
            <Select
              ...
              value={offsetParent}
              onChange={(value) =>
                this.handleOptionsChange({offsetParent: value})
              }
            />
          </div>
  ...
  adjustXY: '${adjustXY}',
        ...
        <section>
          ...
          <pre>
            <code>
              {placement
                ? `position(popup, anchor, ${stringifyObject(
                    presets[placement]
                  )}, options)`
          ...
          <div className={styles.columns}>
            <div>
              ...
              <Select
                ...
                value={popupCorner}
                onChange={(value) =>
                  this.handlePlacementChange({popupCorner: value}, true)
                }
              />
            </div>
            <div>
              ...
              <Select
                ...
                value={anchorCorner}
                onChange={(value) =>
                  this.handlePlacementChange({anchorCorner: value}, true)
                }
              />
            </div>
          </div>
  ...
  renderDemo() {
    ...
    return (
      <div className={styles.demo}>
        {shouldRenderScroller && <div>Scroller</div>}
          ...
          <div className={styles.scrollerInner}>
            ...
            >
              {typeof actualPlacement === 'string' && (
                <Arrow
                  offset={arrowOffset}
                  direction={getOppositePlacement(
